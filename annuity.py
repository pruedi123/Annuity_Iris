...
st.write('Average Cost Increase Factore:${formatted_mean:,.0f}')
st.write('Median Cost Increase Factor:${formatted_median:,0f}')
st.write('Minimum Cost Increase Factor:${formatted_min:,.0f}')
